/**
 * BACKUP: OfflineSyncStatus Component with Full Offline Functionality
 * This is a complete backup of your offline-enabled component
    ...
    >
      <Space direction="vertical" style={{ width: '100%' }}>
        ...
        {testResult && (
          <Alert
            message={testResult}
            type={testResult.includes('✅') ? 'success' : testResult.includes('❌') ? 'error' : 'info'}
            showIcon
            closable
