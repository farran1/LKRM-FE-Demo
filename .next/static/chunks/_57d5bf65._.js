...
function Player() {
    ...
    const searchParams = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSearchParams"])();
    const queryParams = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$app$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(searchParams);
    const API_KEY = "/api/players?".concat((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$querystring$2d$es3$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["stringify"])(queryParams));
    ...
    const sort = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Player.useCallback[sort]": function(sortBy) {
        ...
        "Player.useMemo[columns]": ()=>[
                {
                    ...
                    render: {
                        "Player.useMemo[columns]": (data)=>{
                            return (data === null || data === void 0 ? void 0 : data.avatar) ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("img", {
                                src: data.avatar,
                                width: 24,
                                height: 24,
                ...
                },
                {
                    ...
                    render: {
                        "Player.useMemo[columns]": (data)=>{
                            var _data_position;
                            return data === null || data === void 0 ? void 0 : (_data_position = data.position) === null || _data_position === void 0 ? void 0 : _data_position.name;
                        }
                    }["Player.useMemo[columns]"]
                },
                {
                ...
                },
                {
                    ...
                    render: {
                        "Player.useMemo[columns]": (data)=>{
                            return (data === null || data === void 0 ? void 0 : data.height) ? (data === null || data === void 0 ? void 0 : data.height) + '"' : '';
                        }
                    }["Player.useMemo[columns]"]
                }
            ]
