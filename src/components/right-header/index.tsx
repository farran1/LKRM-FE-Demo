...
import DatabaseIcon from '@/components/icon/database.svg'
...
function RightHeader() {
  ...
  const handleDemoNotifications = () => {
    ...
    // Force a refresh of the notification component
  ...
  return (
    <div className={style.container}>
      <Tooltip title="Demo Data Manager" placement="bottom">
        <DatabaseIcon onClick={handleDemoDataManager} />
      </Tooltip>
      <Tooltip title="Generate Demo Notifications" placement="bottom">
        <button
