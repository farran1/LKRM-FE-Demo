// Full Workflow Live Stat Tracker Test
// This test handles the complete workflow from start to finish

console.log('🏀 Starting Full Workflow Live Stat Tracker Test...');
    ...
    if (clicked) {
      ...
      if (lineupModal) {
        ...
        const selectionMethods = [
          // Method 1: Checkboxes
          () => {
            const checkboxes = lineupModal.querySelectorAll('input[type="checkbox"]');
          ...
          () => {
            const antCheckboxes = lineupModal.querySelectorAll('.ant-checkbox');
          ...
          () => {
            const playerCards = lineupModal.querySelectorAll('[class*="player"], [class*="card"]');
          ...
          () => {
            const clickableElements = lineupModal.querySelectorAll('div[onclick], span[onclick], [role="button"]');
